...
<div class="row notification-pago">
    ...
    <button class="button-admin" id="plataforma"><strong>Pagar Plataforma</strong></button>
</div>
<div class="row notification-pago">
    <p class="text-justify">
    ...
    <button class="button-admin disabled" id="patrocinador"><strong>Pagar a Patrocinador</strong></button>
</div>
<div class="row notification-pago">
    <p class="text-justify">
