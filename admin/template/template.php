...
if(isset($_SESSION["user"])){
    ...
    <script src="/front/js/DataTables-1.10.6/media/js/jquery.dataTables.min.js"></script>
    <script src="/front/js/DataTables-1.10.6/media/js/dataTables.bootstrap.js"></script>
